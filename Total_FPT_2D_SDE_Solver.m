function [LE,LI,LEmax,LImax,M1s_val,M2s_val,Ds_val,rho_o,rho_ln_o,v_o] = Total_FPT_2D_SDE_Solver(v_o,rho_o,rho_ln_o,S_EE,S_IE,S_EI,S_II,NE,NI,N_neuron_fire_first)
N_sample = 10000;
vT =1;vI = -2/3;
