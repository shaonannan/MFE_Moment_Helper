function [mE_ra,mI_ra,rho_o,rho_ln_o,NMDAE,NMDAI] = Transient_2D_SDE_Solver_v2(v_o,rho_o,rho_ln_o,NMDAE,NMDAI,L_EE,L_IE,LE,LI,S_EE,S_IE,S_EI,S_II,D_EE,D_IE,D_EI,D_II,...
